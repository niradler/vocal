    ...
    async def list_models(
        ...
        for prov in providers_to_query:
            try:
                ...
                print(
                    f"Error listing models from provider {prov.get_provider_name()}: {e}"
                )
    ...
    async def get_model(self, model_id: str) -> Optional[ModelInfo]:
        ...
        for provider in self.providers.values():
            try:
                ...
                print(
                    f"Error getting model {model_id} from {provider.get_provider_name()}: {e}"
                )
    ...
    async def download_model(
        ...
        try:
            ...
            async for downloaded, total in provider.download_model(
                model_id, destination, quantization
            ):
