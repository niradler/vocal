...
import asyncio
from huggingface_hub import snapshot_download, list_models, model_info as hf_model_info
from huggingface_hub.utils import HfHubHTTPError

from .base import ModelProvider as BaseProvider
from ..model_info import ModelInfo, ModelStatus, ModelBackend, ModelProvider, ModelTask, format_bytes
    ...
    async def get_model_info(self, model_id: str) -> Optional[ModelInfo]:
        ...
        try:
            ...
            return ModelInfo(
                ...
                languages=self._get_whisper_languages() if "whisper" in model_id.lower() else [],
                ...
                task=ModelTask.STT if model_id in self.KNOWN_STT_MODELS else ModelTask.STT,
            )
