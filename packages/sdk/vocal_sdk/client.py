...
class ModelsAPI:
    ...
    def list(
        self, status: Optional[str] = None, task: Optional[str] = None
    ) -> Dict[str, Any]:
        """
    ...
    def download(
        ...
        return self.client._request(
            "POST", f"/v1/models/{model_id}/download", json=data if data else None
        )
...
class AudioAPI:
    ...
    def _transcribe_file(
        ...
        **kwargs,
        ...
        return self.client._request(
            "POST", "/v1/audio/transcriptions", files=files, data=data
        )
        ...
        **kwargs,
        ...
        if isinstance(file, (str, Path)):
            with open(file, "rb") as f:
                ...
                return self.client._request(
                    "POST", "/v1/audio/translations", files=files, data=data
                )
        else:
            files = {"file": file}
            data = {"model": model, **kwargs}
