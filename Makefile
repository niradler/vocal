.PHONY: help install test test-quick lint format clean serve cli docs gpu-check
...
help:
	...
	@echo ""
	@echo "Testing:"
	@echo "  make test          - Run full E2E test suite (~2 min)"
	@echo "  make test-quick    - Quick validation checks (~30 sec)"
